...
public class OrderDetailController {
        ...
        if (pagination == null) {
            pagination = new AbstractPaginationHelper(10) {
                        ...
                        public DataModel createPageDataModel() {
                            int orderId = Integer.valueOf(
                                        JsfUtil.getRequestParameter("orderId"));

                            //ListDataModel(getFacade().findRange(new int[]{getPageFirstItem(), getPageFirstItem()+getPageSize()}));
                            return new ListDataModel(
                                    getFacade().findOrderDetailByOrder(orderId));
                        }
                    };
        }
    ...
    public static class OrderDetailControllerConverter implements Converter {
        ...
        public Object getAsObject(
            ...
            OrderDetailController controller = (OrderDetailController) facesContext.getApplication()
                                                                                   .getELResolver()
                                                                                   .getValue(
